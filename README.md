...
- macOS 13.0 或更高版本
- Swift 5.9 或更高版本
- 一个 OpenAI Chat Completions 兼容接口的 API Key；如果使用本地 Ollama / localhost 兼容接口，可以不填真实 Key。
...
1. 打开 `译 -> 设置...`，选择 Provider 预设或填入接口地址和模型；云服务需要 API Key，本地 Ollama / localhost 兼容接口可以不填真实 Key。
